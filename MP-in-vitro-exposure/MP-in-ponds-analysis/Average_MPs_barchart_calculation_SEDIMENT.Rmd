...
```{r}
plas <- read.csv("/Users/u0145079/Library/CloudStorage/OneDrive-KULeuven/Desktop/PlasticDaphnia/Publication/tables/MPs_measurments_Sediment.csv")
```
...
```{r}
plas <- read.csv("/Users/u0145079/Library/CloudStorage/OneDrive-KULeuven/Desktop/PlasticDaphnia/Publication/tables/Plastic-composition-Sediment.csv")

plas_norm = plas %>%
  select(PE_PP_per_gram,PS_per_gram,PET_polyester_per_gram,Category,Location) %>%
  melt()
